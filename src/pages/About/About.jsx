      ...
      <div className="intro-img">
        ...
        <div className="introduction">
          ...
          <ul className="socials">
            <li><a href="https://www.facebook.com/profile.php?id=100025798393569&sk=photos" target="blank"><FontAwesomeIcon className='icons' icon={faFacebook} /></a></li>
            <li><a href="https://www.linkedin.com/in/valadasu-naveen-58690a2a4/" target="blank"><FontAwesomeIcon className='icons' icon={faLinkedin} /></a></li>
            <li><a href="https://github.com/naveennani-2605" target="blank"><FontAwesomeIcon className='icons' icon={faGithub} /></a></li>
            <li><a href="https://www.instagram.com/naveennani_006/" target="blank"><FontAwesomeIcon className='icons' icon={faInstagram} /></a></li>
          </ul>
